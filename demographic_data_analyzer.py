...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round((df.loc[higher_education & (df['salary'] == '>50K'), 'education'].count()/df.loc[higher_education,'education'].count())*100,1)
    lower_education_rich = round((df.loc[lower_education & (df['salary'] == '>50K'), 'education'].count()/df.loc[lower_education,'education'].count())*100,1)
    ...
    #amount of people per country earning >50K
    ...
    highest_earning_country = (rich_per_country/populations).idxmax()
    highest_earning_country_percentage = round((rich_per_country/populations).max()*100,1)
